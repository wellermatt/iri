...
setwd(pth.dropbox.code) ; source("./ModelFitting/RegressionModelling/02_regression_functions_modelling.R")
setwd(pth.dropbox.code) ; source("./ModelFitting/RegressionModelling/10_regression_roll_functions.R")
...
# hols:
 ...
 log.model = FALSE
include.AR.terms = FALSE ; price.terms = "PRICE_DIFF"
